...
export default class Gl {
    ...
    init() {
        ...
        if(!window.isIE) {
            ...
            this.$wrap = this.el.querySelector('.c-gl-image_wrap')
            ...
            if (this.$wrap) {
                ...
                if (this.$media) {
                    this.renderer = new ogl.Renderer({ dpr: 1, antialias: !0, premultiplyAlpha: !1, alpha: !0 })
    ...
    initCamera() {
        this.fov = 75
        this.camera = new ogl.Camera(this.glElement, { fov: this.fov })
        this.camera.position.set(0, 0, 1)
    }

    initShape() {
        this.geometry = new ogl.Plane(this.gl, { width: 1, height: 1, widthSegments: 10, heightSegments: 10 })
        this.texture = new ogl.Texture(this.gl, { minFilter: this.gl.LINEAR })
